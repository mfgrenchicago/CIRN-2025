...
class JobBoardViewModel  {
     var jobs: [Job] = [
        ...
        Job(
            title: "Elkay Manufacturing Company",
        ...
        Job(
            title: "OSI Group (Chicago plants)",
